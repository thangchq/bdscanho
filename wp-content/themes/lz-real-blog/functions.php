...
function lz_real_blog_setup() {
	...
	load_theme_textdomain( 'lz-real-blog' );
	...
	register_nav_menus( array(
		...
		'footer'	=> __('Footer Menu', 'lz-real-blog'),
	) );
...
function lz_real_blog_scripts() {
	...
	wp_enqueue_script( 'lz-real-blog-skip-link-focus-fix', get_theme_file_uri( '/assets/js/skip-link-focus-fix.js' ), array(), '1.0', true );

	$lz_real_blog_l10n=array();
	
	if ( has_nav_menu( 'top' ) ) {
		wp_enqueue_script( 'lz-real-blog-navigation-jquery', get_theme_file_uri( '/assets/js/navigation.js' ), array( 'jquery' ), '1.0', true );
		$lz_real_blog_l10n['expand']         = __( 'Expand child menu', 'lz-real-blog' );
		$lz_real_blog_l10n['collapse']       = __( 'Collapse child menu', 'lz-real-blog' );		
	}
	...
	wp_localize_script( 'lz-real-blog-skip-link-focus-fix', 'lz_real_blogScreenReaderText', $lz_real_blog_l10n );
...
//footer Link
define('LZ_REAL_BLOG_FACEBOOK','https://www.facebook.com/sharer/sharer.php?u=','lz-real-blog');
define('LZ_REAL_BLOG_TWITTER','https://twitter.com/share?url=','lz-real-blog');
define('LZ_REAL_BLOG_LINKDIN','https://www.linkedin.com/shareArticle?mini=true&url=','lz-real-blog');
define('LZ_REAL_BLOG_INSTAGRAM','http://www.instagram.com/submit?url=','lz-real-blog');
define('LZ_REAL_BLOG_PINTREST','http://www.pinterest.com/submit?url=','lz-real-blog');
define('LZ_REAL_BLOG_CREDIT','https://www.luzuk.com/','lz-real-blog');

if ( ! function_exists( 'lz_real_blog_credit' ) ) {
	function lz_real_blog_credit(){
		echo "<a href=".esc_url(LZ_REAL_BLOG_CREDIT)." target='_blank'>".esc_html__('Luzuk','lz-real-blog')."</a>";
	}
}
