...
//add_action( 'wp_head', 'septera_enqueue_styles', 5 );   // switched in v1.1
...
function septera_scripts_method() {
	...
	list( $sitewidth,
		...
		'septera_sitewidth',
		'septera_primarysidebar',
		'septera_secondarysidebar',
		'septera_lpboxrow1',
		'septera_lpboxlayout1',
		'septera_lpboxheight1',
		'septera_lpboxwidth1',
		'septera_lpboxrow2',
		'septera_lpboxlayout2',
	...
	wp_localize_script( 'septera-frontend', 'septera_settings', $js_options );
...
add_filter( 'script_loader_tag', 'septera_scripts_filter', 10, 2 );
...
function septera_add_editor_styles() {
	...
	add_editor_style( add_query_arg( 'action', 'septera_editor_styles', admin_url( 'admin-ajax.php' ) ) );
	add_action( 'wp_ajax_septera_editor_styles', 'septera_editor_styles' );
	add_action( 'wp_ajax_no_priv_septera_editor_styles', 'septera_editor_styles' );
