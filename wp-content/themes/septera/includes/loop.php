...
function septera_remove_category_tag( $text ) {
	$text = str_replace( 'rel="category tag"', 'rel="tag"', $text );
	return $text;
} //septera_remove_category_tag()
//add_filter( 'the_category', 'septera_remove_category_tag' );
//add_filter( 'get_the_category_list', 'septera_remove_category_tag' );
